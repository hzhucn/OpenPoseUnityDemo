	...
	public static class OPOutputParser {
		...
		public static void ParseOutput(ref OPDatum datum, IntPtr[] ptrArray, int[] sizeArray, OutputType type){
			switch (type){
				...
				case OutputType.PoseScores: ParseScores(ref datum, ptrArray, sizeArray); break;
		...
		public static void ParseScores(ref OPDatum datum, IntPtr[] ptrArray, int[] sizeArray){
